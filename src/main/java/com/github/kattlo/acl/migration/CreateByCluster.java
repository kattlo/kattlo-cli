 ...
 */
@Slf4j
public class CreateByCluster extends AbstractCreate {

    static final String RELATIVE_POINTER = "#/cluster";

    public CreateByCluster(JSONObject migration) {
        super(migration);
    }
    ...
    protected List<AclBinding> bindingsFor(String principal, JSONObject access,
        ...
        var pattern = new ResourcePattern(ResourceType.CLUSTER,
            ResourcePattern.WILDCARD_RESOURCE, PatternType.PREFIXED);

        log.debug("Cluster resource pattern {}", pattern);
