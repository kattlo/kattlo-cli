...
public class CreateByGroupTest extends AclCreateTestBase {

    @Test
    public void should_throw_when_invalid_allow_operation() {
        // setup
        var yaml = Path.of("./src/test/resources/acl/by-principal/v0001_create-group-invalid-allow.yaml");
    ...
    public void should_throw_when_invalid_deny_operation() {
        // setup
        var yaml = Path.of("./src/test/resources/acl/by-principal/v0001_create-group-invalid-deny.yaml");
        var map = Loader.loadAsMap(yaml);
    ...
    public void should_throw_when_allow_and_deny_has_the_same_operation() {
        // setup
        var yaml = Path.of("./src/test/resources/acl/by-principal/v0001_create-group-same-operation-allow-deny.yaml");
        var map = Loader.loadAsMap(yaml);
    ...
    public void should_throw_when_allow_and_deny_host_has_the_same_ip() {
        // setup
        var yaml = Path.of("./src/test/resources/acl/by-principal/v0001_create-group-same-ip-allow-deny.yaml");
        var map = Loader.loadAsMap(yaml);
    ...
    public void should_create_just_with_allow_operation() throws Exception{
        // setup
        var yaml = Path.of("./src/test/resources/acl/by-principal/v0001_create-group-just-allow.yaml");
        var map = Loader.loadAsMap(yaml);
    ...
    public void should_create_just_with_deny_operation() throws Exception{
        // setup
        var yaml = Path.of("./src/test/resources/acl/by-principal/v0001_create-group-just-deny.yaml");
        var map = Loader.loadAsMap(yaml);
    ...
    public void should_create_with_allow_and_deny_operation() throws Exception {
        // setup
        var yaml = Path.of("./src/test/resources/acl/by-principal/v0001_create-group-allow-and-deny.yaml");
        var map = Loader.loadAsMap(yaml);
    ...
    public void should_create_with_prefixed_id() throws Exception {
        // setup
        var yaml = Path.of("./src/test/resources/acl/by-principal/v0001_create-group-prefixed-name.yaml");
        var map = Loader.loadAsMap(yaml);
        ...
        assertEquals("my-group-", acl0.pattern().name());
    }
