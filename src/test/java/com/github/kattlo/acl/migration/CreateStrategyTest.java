...
public class CreateStrategyTest {
    ...
    public void should_create_topic_with_allow_producer() throws Exception {
        ...
        // TODO update the by-principal.schema.json

        var yaml = Path.of("./src/test/resources/acl/by-principal/v0001_create-allow-producer.yaml");
        var map = Loader.loadAsMap(yaml);
    ...
    public void should_create_topic_with_deny_producer() throws Exception {
        ...
        var yaml = Path.of("./src/test/resources/acl/by-principal/v0001_create-deny-producer.yaml");
        var map = Loader.loadAsMap(yaml);
    ...
    @Test
    public void should_create_topic_with_allow_consumer() {

    }

    @Test
    public void should_throw_when_allow_consumer_and_top_level_topic_has_same_value() {
    ...
    @Test
    public void should_create_topic_with_deny_consumer() {

    }

    @Test
    public void should_throw_when_deny_consumer_and_top_level_topic_has_same_value() {

    }

    @Test
    public void should_throw_when_deny_consumer_and_top_level_group_has_same_value() {
